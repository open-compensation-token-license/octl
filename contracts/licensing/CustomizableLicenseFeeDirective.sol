...
//A license pricing that can be customized
// via an equation and variables 
// TODO: Test and develop this completely
// once this is working third parties could add licenses easily with computation directives 
contract CustomizableLicenseFeeDirective is
    ...
    UUPSUpgradeable
{
    ...
    function computeLicenseCosts(
        ...
        return uint256(calculateExpression(
            abi.decode(computationDetails, (string)), variables, int256(storyPoints)))/_OneStoryPoint;
    }
